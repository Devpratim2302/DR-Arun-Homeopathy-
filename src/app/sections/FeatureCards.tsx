...
import imgClinicBg from '@/assets/homeo/homeo_clinic_bg.png';
...
export default function FeatureCards({ openBookingModal }: { openBookingModal: () => void }) {
  return (
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div {...fadeInUp} className="bg-gradient-to-br from-[#1B3A6B] to-[#4A7CC9] rounded-2xl p-6 text-white shadow-xl">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span>Monday – Saturday</span><span className="font-semibold">10:00 AM – 8:00 PM</span></div>
              <div className="flex justify-between"><span>Sunday</span><span className="font-semibold">10:00 AM – 8:00 PM</span></div>
            </div>
          ...
          <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.15 }}
            ...
            <p className="text-white/80 text-sm leading-relaxed mb-6">
              Visakhapatnam · Vizinagaram · Vissannapeta
            </p>
          ...
          <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.3 }}
            ...
            <img src={imgClinicBg} alt="Clinic"
