        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-white/50">
              <div className="flex justify-between"><span>Mon – Sun</span><span className="text-white/70">10:00 AM – 8:00 PM</span></div>
            </div>
          </div>

          {/* Address */}
          <div>
            <h4 className="font-bold text-white mb-4 text-sm uppercase tracking-wider">Our Locations</h4>
            <p className="text-white/50 text-sm leading-relaxed">
              Visakhapatnam (HQ) · Vizianagaram · Vissannapeta
            </p>
            <p className="text-white/30 text-[11px] mt-2 leading-tight">
              Sri Sai Nivas, Seethammadara, Visakhapatnam, AP 530013
            </p>
            <p className="text-[#C62828] font-bold text-sm mt-4 flex items-center gap-2">
              <span className="animate-pulse">📞</span> +91 72071 15599
            </p>
          </div>
        </div>
      </div>
