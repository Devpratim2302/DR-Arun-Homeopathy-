...
const services = [
  { icon: HeartPulse, title: 'Cardiovascular Care', desc: 'Expert management of hypertension, coronary diseases, and metabolic heart health using personalized homeopathic protocols.', img: imgCardiovascular, tag: 'HEART HEALTH' },
  { icon: Wind, title: 'Respiratory Diseases', desc: 'Safe and effective holistic approach to asthma, bronchitis, and chronic sinus conditions with long-term recovery focus.', img: imgRespiratory, tag: 'LUNG CARE' },
  { icon: Brain, title: 'Headache & Migraine', desc: 'Deeply tailored treatments to alleviate chronic pain and reduce migraine frequency through constitutional remedies.', img: imgMigraine, tag: 'NEUROLOGY' },
  { icon: Activity, title: 'Endocrine Support', desc: 'Restoring hormonal balance and treating thyroid disorders naturally by addressing the root cause of metabolic issues.', img: imgEndocrine, tag: 'METABOLIC' },
  { icon: Baby, title: 'Pediatric Care', desc: 'Gentle, side-effect-free healing for children, supporting growth, immunity, and overall developmental wellness.', img: imgPediatric, tag: 'CHILD CARE' },
];
