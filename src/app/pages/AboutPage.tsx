...
import { Shield, Heart, Award, Users, CheckCircle, Building2 } from 'lucide-react';
...
const milestones = [
  ...
  { year: '2022', title: '3 Locations', desc: 'Grew to 3 clinic locations across Visakhapatnam.' },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.2 }}>
              ...
              <p className="text-[#5A6077] leading-relaxed mb-8">
                Founded in 2009, our clinic has grown from a single-room practice to a network of 3 locations across Visakhapatnam, treating over 50,000+ patients with a 4.9-star Google rating. We believe in treating the root cause, not just the symptoms.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Building2, num: '3', label: 'Clinic Locations' },
