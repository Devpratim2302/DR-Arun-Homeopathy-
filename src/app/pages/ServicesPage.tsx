...
import imgCardiovascular from '@/assets/homeo/homeo_cardio.jpeg';
import imgRespiratory from '@/assets/homeo/homeo_resp.jpeg';
import imgMigraine from '@/assets/homeo/homeo_migraine.jpeg';
import imgEndocrine from '@/assets/homeo/homeo_endo.jpeg';
import imgPediatric from '@/assets/homeo/homeo_peds.jpeg';
...
const services = [
  { icon: HeartPulse, title: 'Cardiovascular & Critical Conditions', desc: 'Comprehensive care for hypertension, coronary artery disease, and other critical heart conditions using natural remedies.', img: imgCardiovascular, tag: 'Primary Care' },
  { icon: Wind, title: 'Respiratory Diseases', desc: 'Holistic approach to asthma, bronchitis, and interstitial lung disease focusing on long-term immunity.', img: imgRespiratory, tag: 'Specialized' },
  { icon: Brain, title: 'Headache & Migraine', desc: 'Scientific treatments to alleviate chronic pain and reduce the frequency of migraine attacks effectively.', img: imgMigraine, tag: 'Neurological' },
  { icon: Activity, title: 'Endocrine & Metabolic Disorders', desc: 'Restoring hormonal balance and treating metabolic issues through personalized homeopathic protocols.', img: imgEndocrine, tag: 'Metabolic' },
  { icon: Baby, title: 'Pediatric Care', desc: 'Gentle and safe healing for childhood conditions, ensuring healthy development without side effects.', img: imgPediatric, tag: 'Child Health' },
];

export default function ServicesPage({ openBookingModal, openQuestionModal }: { openBookingModal: () => void; openQuestionModal: () => void }) {
