...
function ScrollToTop() {
  ...
  useEffect(() => {
    if (!hash) {
      ...
      // Delay to allow the new page to fully mount before scrolling
...
function MainLayout() {
  ...
  const openBookingModal = () => { setModalMode('booking'); setIsBookingModalOpen(true); };
  const openQuestionModal = () => { setModalMode('question'); setIsBookingModalOpen(true); };
  ...
  return (
    <div className="bg-[#F0F4FA] min-h-screen">
      ...
      <BookingModal isOpen={isBookingModalOpen} onClose={closeBookingModal} mode={modalMode} />
      ...
      <main>
        <Routes>
          ...
          <Route path="/services" element={<ServicesPage openBookingModal={openBookingModal} openQuestionModal={openQuestionModal} />} />
          <Route path="/testimonials" element={<TestimonialsPage openBookingModal={openBookingModal} />} />
          <Route path="/blog" element={<BlogPage />} />
          <Route path="/service/:serviceName" element={<ServiceDetailPage openBookingModal={openBookingModal} />} />
        </Routes>
      </main>
      ...
      {/* Floating WhatsApp Style Booking Button */}
